...
*** acquisition: lots of flexibility there!
    ...
    characterized by initial flexibility, which declines over development.  As
    infants become better at discriminating linguistically important sounds in
    their native language, they simultaneously /lose/ the ability to
    discriminate sounds that are important for other languages but not their
    native language [@Best1995; @Kuhl1992; @Werker1984].
...
*** distributional learning
    The flexibility exhibited during acquisition /and/ adult adaptation has been
    hypothesized to reflect /distributional learning/, 

    both acquisition and adaptation have been theorized to be forms of
    distributional learning.  A number of different computational models of
    acquisition show that many phonetic categories can be learned simply by
    distributional learning [], although in many cases this may require
    considering that phonetic categories occur in lingustic context to be fully
    effective [@Feldman2013; @Hitczenko2018]
