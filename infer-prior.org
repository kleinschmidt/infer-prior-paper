...
*** remarkable flexibility in adult language
    ...
    adaptation (increase in comprehension accuracy and speed).  recalibration:
    rapid changes in category boundaries with a few labeled examplars
...
*** goals: systematically probe constraints on distributional learning 
    ...
    distributional learning in English-speaking adults.
