...
*** TODO compute savage-dickey bayes factor for sup vs. unsup
    ...
    WIP in [[file:models/brms_regressions.R::b_logit_sup_v_unsup_w_prior <- brm(f2_int,][brms_regression.R]]
** TODO edit intro
...
** TODO editing misc
*** I vs. we
*** what about things babies are bad at/don't lose?
...
*** when does the "three cluster" stuff come in?
    Elika thought that in model, exp 4, and gen disc was too much.  "cut/smooth/etc"
