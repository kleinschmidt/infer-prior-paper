...
bibliography: /home/dave/Documents/papers/library-clean.bib
output:
    html_document:
        code_folding: hide
        dev: png
...
mod_inc_samples <- readRDS("models/samples_inc_lapsing.rds")

```

```{r load-summary}
mod_summary <- readRDS('models/summary_lapsing.rds')
mod_inc_summary <- readRDS("models/summary_inc_lapsing.rds")
```
...
```{r plot-exp2-inc-predictions, fig.width=8, fig.height=2, fig.cap="Predicted classification functions for conditions from Experiment 2 based on prior beliefs inferred from Experiment 1"}
