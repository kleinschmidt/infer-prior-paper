...
acquisition [@McMurray2010; @Vallabha2007; @Feldman2013; but see
...
[@Kleinschmidt2015]. Both of these factors might contribute to
...
(Figure -@fig:lapse-rate-by-block).  The inferred lapse rate is nearly 12% in the first
...
prior beliefs.  The prior pseudocount for the means was
`r confidence_summaries$kappa_0_mean` (95% credible interval of
$[`r confidence_summaries['kappa_0_low']`,
`r confidence_summaries['kappa_0_high']`]$).
