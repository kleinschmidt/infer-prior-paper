...
compared with exposure distributions with 15ms differences between boundaries)
and not particularly reliable (going in the expected direction with 
$p=`r boundary_diff_p_vals[['p']][1]`$[^bayes_p2] for the -20ms vs. -50ms /b/
conditions and $p=`r boundary_diff_p_vals[['p']][3]`$ for -50ms vs. -80ms /b/)
