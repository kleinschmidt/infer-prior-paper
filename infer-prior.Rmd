...
[@fig:exp1-results] and the category boundaries [@fig:exp1-boundaries] suggests
...
appear to be a compromise between that boundary and the boundary corresponding
to a typical talker of American English (thin black colored lines).
