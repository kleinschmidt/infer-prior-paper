...
```{r plot-modeled-category-boundaries, fig.width=6.2, fig.height=3.8, fig.cap="Belief updating model's change in category boundary in each VOT condition over trials"}
