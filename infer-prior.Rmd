...
distributional learning, even using a restricted set of distributions.  The
exposure distributions from this epxeriemtn differed in two important ways from
those of the earlier experiments.  First, they included large negative VOTs in
some conditions, for which little distributional learning was observed.  This is
consistent with @Sumner2011, who also found that negative VOTs failed to produce
large shifts in category boundaries except in a few particular presentation
orders.

Second, the means of the high and low VOT clusters (implicitly /b/ and /p/)
moved together in lock-step in Experiments 1 and 2, while in Experiment 4 they
were manipulated independently.  Varying the means of each cluster together
...
shift in the boundary between /b/ and /p/, since continuing to use the ideal
boundary for a "typical talker" would yield low error rates (see Figure
