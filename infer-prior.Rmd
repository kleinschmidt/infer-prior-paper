...
shift in the boundary between /b/ and /p/ in order to achieve a low error.  In
fact, for all the exposure distributions tested in Experiment 4, continuing to
use the ideal boundary for a "typical talker" would yield low error rates (less
than `r max_error_perc` in all conditions; see Figure
