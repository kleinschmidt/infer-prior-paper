...
prior experience that the system can draw on.
...
of @Marr1982], this is also a problem of distributional learning: in order to
effectively adapt to an unfamiliar talker's accent, a listener needs to have
some reasonably good estimate of the distribution of talkers' accents that
exist in their environment [@Kleinschmidt2015b].

<!-- maybe some tie in with exemplar theories and "life long statistical -->
<!-- learning" elman stuff? -->
...
This raises an important set of questions for future research: what
distributions are *available* for learning, and do listeners' distribution
