...
@Marr1982], acquisition simply *is* a problem of distributional learning.  The
...
accommodating talker variabiltiy is also, at a computational level, a problem of
...
[@McMurray2009; @Vallabha2007; @Feldman2013; but see @Hitczenko2018] and rapid
...
acquisition and adult language use and adptation.  The idea that statistical
...
In all of these views, acquisition and adaptation are both forms of
...
distributional learning.  In order to effectively adapt to an unfamiliar
...
related to the distribution of talkers' accents that exist in their environment.
...
them is caused by distributional learning at another level.  The existing
evidence for this claim was reviewed in @Kleinschmidt2015b, and I will not
revisit it here in depth.  One additional piece of evidence for this possibility
is that learning at the second level (of talker variability) appears to opperate
...
what distributions are *available* for learning, and (2) do listeners'
distributional learning biases and constraints reflect the distributions across
talkers that they have experienced?
...
talkers than voicing of stop consonants [@Kleinschmidt2019], even once
variability in vocal tract length is taken into account.  Moreover, this
variability is in many cases highly structured *within* a talker, across
categories [@Chodroff2017].
...
learning during adaptation.  Because talkers are consistent in their realization
of vowels, learning should be relatively stable and accumulate evidence over
time.  Because vowels are more variable than stop voicing, listeners should
show less constrained, more strongly experience-driven distributional learning
of vowels than stop voicing.  Because certain phonemes' distributions are
...
Still, the studies of variability in production are only scratching the surface
