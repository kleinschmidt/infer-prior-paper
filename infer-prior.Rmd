...
200), but @Kleinschmidt2015 found prior pseudocounts on the order of 10s of
...
variance.[^normal-prior] This means that according to the model, a listener's
expectations of how much talker variability there is in the _mean_ of a catgory
is directly linked to how much _within_-talker variability they expect (e.g.,
the category variance).  This (mathematically convenient) relationship need not
hold in reality: it is logically possible that talkers might vary dramatically
in the phonetic target that they nevertheless achieve very precisely (high
between-talker variance and low within-talker variance), or 
